...
function cleanDocument(document, { removeUnused = true, generateId = defaultGenerateId, includeSource = true, } = {}) {
    if (removeUnused) {
    ...
    const id = generateId(graphql_1.print(normalizedDocument));
